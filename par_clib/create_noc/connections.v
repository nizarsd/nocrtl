...
assign rx_l_data[2] = source_data[2];
assign rx_l_valid[2] = source_valid[2];
assign source_busy[2] = rx_busy[2][4];

assign sink_data[2] = tx_l_data[2];
assign sink_valid[2] = tx_l_valid[2];
assign tx_busy[2][4] = sink_busy[2];

assign rx_l_data[3] = source_data[3];
assign rx_l_valid[3] = source_valid[3];
assign source_busy[3] = rx_busy[3][4];

assign sink_data[3] = tx_l_data[3];
assign sink_valid[3] = tx_l_valid[3];
assign tx_busy[3][4] = sink_busy[3];

assign rx_l_data[4] = source_data[4];
assign rx_l_valid[4] = source_valid[4];
assign source_busy[4] = rx_busy[4][4];

assign sink_data[4] = tx_l_data[4];
assign sink_valid[4] = tx_l_valid[4];
assign tx_busy[4][4] = sink_busy[4];

assign rx_l_data[5] = source_data[5];
assign rx_l_valid[5] = source_valid[5];
assign source_busy[5] = rx_busy[5][4];

assign sink_data[5] = tx_l_data[5];
assign sink_valid[5] = tx_l_valid[5];
assign tx_busy[5][4] = sink_busy[5];

assign rx_l_data[6] = source_data[6];
assign rx_l_valid[6] = source_valid[6];
assign source_busy[6] = rx_busy[6][4];

assign sink_data[6] = tx_l_data[6];
assign sink_valid[6] = tx_l_valid[6];
assign tx_busy[6][4] = sink_busy[6];

assign rx_l_data[7] = source_data[7];
assign rx_l_valid[7] = source_valid[7];
assign source_busy[7] = rx_busy[7][4];

assign sink_data[7] = tx_l_data[7];
assign sink_valid[7] = tx_l_valid[7];
assign tx_busy[7][4] = sink_busy[7];

assign rx_l_data[8] = source_data[8];
assign rx_l_valid[8] = source_valid[8];
assign source_busy[8] = rx_busy[8][4];

assign sink_data[8] = tx_l_data[8];
assign sink_valid[8] = tx_l_valid[8];

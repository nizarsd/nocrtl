...
// 	parameter table_file ="";
	...
	wire [`HDR_SZ + `PL_SZ + `ADDR_SZ-1:0] rr_item_out[`DIRECTIONS-1:0];
      ...
      (* mark_debug = "true" *) wire  [`HDR_SZ + `PL_SZ + `ADDR_SZ-1:0] fifo_out_dbg;
      (* mark_debug = "true" *) wire  valid_dbg;
      (* mark_debug = "true" *) wire  rx_w_busy__dbg;
      (* mark_debug = "true" *) wire  rx_w_data__dbg;
      (* mark_debug = "true" *) wire full_l_dbg;
       
       assign valid_dbg  = valid[`WEST];
       assign rx_w_busy__dbg = rx_w_busy;
       assign rx_w_data__dbg = rx_w_data;
       assign full_l_dbg = full[`WEST];
       assign fifo_out_dbg = fifo_item_out[`WEST ];
       
       
	wire tx_active [`DIRECTIONS-1:0];
	
	(* mark_debug = "true" *) wire read[`DIRECTIONS-1:0]; //  fifo pop signal (routing_logic -> fifo)
...
// 	
	...
	genvar channel;
		...
		(* dont_touch = "true" *)  ch_rx_logic rx_logic(
	...
	(* dont_touch = "true" *)  par_rx_logic rx_l(.item_out(fifo_item_in[`LOCAL]), .write(write[`LOCAL]), .full(full[`LOCAL]), 
...
//        routing_logic #(routerid,table_file) rr_routing_logic(
       (* dont_touch = "true" *)  routing_logic routing_logic0 (
	...
	(* dont_touch = "true" *)  dclk_tx #("north") tx_n
	(
	...
	(* dont_touch = "true" *)  dclk_tx #("east") tx_e
	(
	...
	(* dont_touch = "true" *)  dclk_tx #("south") tx_s
	(
	...
	(* dont_touch = "true" *)  dclk_tx #("west") tx_w
	(
